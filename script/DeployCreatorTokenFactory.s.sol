...
contract DeployCreatorTokenFactory is Script {
    function run() public {
        ...
        bytes memory constructorArgs =
            abi.encode(futureCreatorTokenFactory, BaseUniswapDeployments.POOL_MANAGER());
        ...
        require(
            address(creatorTokenFactory) == futureCreatorTokenFactory, "Factory address mismatch"
        );
        ...
        UniversalAntiFlipFeeHook deployedHook = new UniversalAntiFlipFeeHook{
            salt: salt
        }(address(creatorTokenFactory), BaseUniswapDeployments.POOL_MANAGER());
